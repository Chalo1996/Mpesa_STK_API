...
export function CallbacksLogPage() {
  ...
  async function load() {
    ...
    try {
      const result = await apiRequest("/api/v1/admin/logs/callbacks", {
        method: "GET",
      });
  ...
  return (
    <section className='page'>
      <h1 className='page__title'>Callback Logs</h1>
      <p className='page__desc'>
        Calls <code>/api/v1/admin/logs/callbacks</code> (protected).
      </p>
