...
export function StkErrorsLogPage() {
  ...
  async function load() {
    ...
    try {
      const result = await apiRequest("/api/v1/admin/logs/stk-errors", {
        method: "GET",
      });
  ...
  return (
    <section className='page'>
      <h1 className='page__title'>STK Error Logs</h1>
      <p className='page__desc'>
        Calls <code>/api/v1/admin/logs/stk-errors</code> (protected).
      </p>
